...
$string['paymentrequired'] = 'Необходимо совершить пожертвование, чтобы разблокировать остальные ресурсы этого курса.';
$string['donate'] = '<div>Версия плагина: {$a->release} ({$a->versiondisk})<br>
Новые версии плагина вы можете найти на <a href=https://github.com/Snickser/moodle-mod_gwpayments>GitHub.com</a>
...
$string['expirynotify'] = 'Уведомлять студента об истечении срока разблокировки';
$string['expiredmessagesubject'] = 'Уведомление об истечении срока обучения';
$string['expiredmessagebody'] = 'Здравствуйте {$a->fullname}!

Уведомляем о том, что срок действия вашего платежа скоро истекает.
«{$a->module}»
{$a->url}
';
